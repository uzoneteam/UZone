...
namespace UZone
{
    public partial class SiteMaster : MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           //CheckStatus();
            ...
            if (Session["isLogged"] != null && Session["isLogged"].ToString() == "true")
            {
                ...
                lbLoggedIn.InnerText = "Welcome, " + Session["userName"].ToString();
        ...
        private void CheckStatus()
        {
            ...
            if (blockApplicationPath.Contains("Admin") && Session["userRole"] != "1" && (Session["isLogged"] == null || Session["isLogged"].ToString() == "false"))
